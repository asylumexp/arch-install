...
yay -S --needed --mflags google-chrome-beta ttf-carlito spotify tidal-hifi-bin steam discord polymc-bin discover onlyoffice-bin ntfs-3g protonvpn mate-system-monitor gnome-system-monitor ocs-url teamviewer-beta discover-overlay neofetch jre17-openjdk jdk17-openjdk noto-fonts-emoji ttf-twemoji ttf-twemoji-color # Install most packages
